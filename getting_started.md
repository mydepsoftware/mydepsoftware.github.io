...
<p> MyDEP can be run on Windows, Mac OS X or Linux/Ubuntu operating systems. It requires Java to be installed on your system. Please check you have the latest recommended version of Java installed on your computer. Otherwise it can be downloaded <a href="https://java.com/en/download">here</a> (May 2022: Version 8 Update 333). </p>
